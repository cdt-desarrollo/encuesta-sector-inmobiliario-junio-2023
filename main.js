...
function sendData(array) {
    ...
    var config = {
      method: "post",
      url: "https://sheet.best/api/sheets/32aacf91-902e-4e88-8d70-e596b2f41ceb/tabs/jun2023",
      mode: "cors",
      headers: {
  ...
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      if(ciudad == ""){
        ...
        if (inputObject.id == "otrosjunq11") {
          document.getElementById("insertCityjunq11").innerHTML = "";
          document.getElementById("otrosjunq11").value = ciudad;
  ...
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      if(uso == ""){
        ...
        if(inputObject.id == "otrosjunq15"){
          document.getElementById("insertUsejunq15").innerHTML = "";
          document.getElementById("otrosjunq15").value = uso;
          document.getElementById(
            "insertUsejunq15"
